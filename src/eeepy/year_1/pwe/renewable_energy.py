#!/usr/bin/env python3
"""Module containing functions and equations relating to renewable
 energy."""
from math import pi

from eeepy.utils.constants import Cpmax, rowAir
...
def power_wind_turbine_power(Pw: float, Cp: float = Cpmax) -> float:
    """
    Calculates the power generated by a wind turbine
    """
    return Cp * Pw
...
def tip_speed(r: float, rpm: float = 0) -> float:
    """
